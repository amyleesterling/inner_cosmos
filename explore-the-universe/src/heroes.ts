...
import { REAL_NEURON_SVG } from "./realNeuron";
...
// ─── Pyramidal neuron ─────────────────────────────────────────────────────
// A real reconstructed pyramidal cell from the MICrONS cubic millimeter
// dataset, sampled to ~3000 vertices and projected to 2D with its long axis
// aligned vertically. SVG is generated by scripts/extract-neuron-svg.mjs.
// Honours the project's "real data, never decorative substitutes" rule —
// every dot here is a real point on the surface of one real neuron.
function neuron(): string {
  return REAL_NEURON_SVG;
}
